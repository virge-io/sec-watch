...
func WriteHTML(w io.Writer, result *scanner.TrivyResult, s *cache.Status, projectsDir string, recentDays int) error {
...
<div class="pill">Recent high/critical changes: {{.Stats.DepRecentCount}}</div>
</div>
...
<th class="date" data-sort="text">Changed</th>
...
<th class="fixed" data-sort="text">Fixed</th>
...
<td class="package">{{$f.Package}}</td>
<td class="version">{{$f.Installed}}</td>
<td class="fixed">{{$f.Fixed}}</td>
